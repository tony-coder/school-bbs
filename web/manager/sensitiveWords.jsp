    ...
    <div class="row">
        <div class="col-xs-3">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li role="presentation" class="active"><a href="<%=path%>/getAllSensitiveWords.action">管理敏感词</a></li>
            </ul>
        </div>
        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                                ...
                                <td>
                                    <div class="btn-group" >
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="<%=path%>/deleteSensitiveWord.action?id=<s:property value="%{#sensitiveWord.id}"/>">删除敏感词</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </s:iterator>
                    ...
                    <form name="fileForm1" style="float: right;" class="navbar-form navbar-left" role="search" action="<%=request.getContextPath()%>/addSensitiveWord.action">
                        <div class="input-group" style="width: 300px">
                            <input type="text"  class="form-control" id="sensitiveWord" name="sensitiveWord.word" placeholder="请输入敏感词">
