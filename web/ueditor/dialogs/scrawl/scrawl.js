...
(function () {
    function _appendStyle() {
        var doc = document,
            ...
            cssText = '.scale{visibility:hidden;cursor:move;position:absolute;left:0;top:0;width:100px;height:50px;background-color:#fff;font-size:0;line-height:0;opacity:.4;filters:Alpha(opacity=40);}'
