            ...
            <ul class="list-group">
                ...
                <s:iterator value="#request.topics">
                    <div class="list-group-item">
                        <a href="topicDetail.action?topicId=<s:property value="id"/>&&pageNum=1"
                           style="color:grey">
                        ...
                        <s:if test="type==0">
                            <a href="applybest.action?bestTopic.topicByTopicId.id=<s:property value="id"/>"
                               style="float: right">申请精华贴&nbsp;</a>
                        </s:if>
