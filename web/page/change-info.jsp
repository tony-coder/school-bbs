    ...
    <div class="row">
        <div class="col-xs-3">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li role="presentation"><a href="<%=path%>/page/records.jsp">申请记录</a></li>
            </ul>
        </div>
                ...
                <div class="panel-body">
                    <form id="form1" action="updateUser.action" method="post" enctype="multipart/form-data">
                        <div class="column">
                            ...
                            <dl class="form-group">
                                <dt><%--@declare id="user_profile_company"--%><label for="user_profile_company">密码</label></dt>
                                <dd><input id="password" class="form-control" name="user.password" size="30" type="password" width="200px" /></dd>
                            </dl>
                            <dl class="form-group">
                                <dt><%--@declare id="user_profile_location"--%><label for="user_profile_location">重复密码</label></dt>
